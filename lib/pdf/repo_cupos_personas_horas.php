...
if($legajo==""){
$query="select fecha_hora_extra,legajo_fk,apellido,empleados.nombre as nom_persona,tipo_hora_fk,hs_solicitadas,hs_realizadas,pago,numero_nota,fecha_nota,horas_tipo.nombre as hora_tipo
from cupos_horas_personas inner join empleados on cupos_horas_personas.legajo_fk=empleados.legajo
inner join horas_tipo on cupos_horas_personas.tipo_hora_fk=horas_tipo.id_tipo_hora
where fecha_hora_extra >='$fdesde' and fecha_hora_extra<='$fhasta' order by fecha_hora_extra";
}
else
{
$query="select fecha_hora_extra,legajo_fk,apellido,empleados.nombre as nom_persona,tipo_hora_fk,hs_solicitadas,hs_realizadas,pago,numero_nota,fecha_nota,horas_tipo.nombre as hora_tipo
from cupos_horas_personas inner join empleados on cupos_horas_personas.legajo_fk=empleados.legajo
inner join horas_tipo on cupos_horas_personas.tipo_hora_fk=horas_tipo.id_tipo_hora
where legajo_fk='$legajo' and fecha_hora_extra >='$fdesde' and fecha_hora_extra<='$fhasta' order by apellido,fecha_hora_extra";
}
