...
$txt_checkboxCastrado = $_POST['checkboxCastrado']; 
if($txt_checkboxCastrado == "on")$txt_checkboxCastrado = 1; else $txt_checkboxCastrado = 0; 
...
{	
	...
	$update = sql_update_ejemplar($txt_id_ejemplar,$txt_nombre_ejemplar,$txt_caracter,$txt_anios,$txt_especie,$txt_raza ,$select_pelaje,$select_tamanio,$txt_sexo,$txt_capturas,$txt_observaciones,$txt_checkboxAdopatdo,$txt_checkboxCastrado,$txt_checkboxSenial,$txt_checkboxEsterilizado,$select_persona,$txt_checkboxFalecido);
	  ...
	  <tr>
        ...
        <td><form id="form_mod_ejemplar" name="form_mod_ejemplar" method="post" onsubmit="" action="frm_mod_ejemplar.php"  >
            <table width="770" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" valign="bottom" bgcolor="#D3DBE2"><table width="307" height="153" border="0" align="left" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF">
                  <tr>
                  ...
                  <tr>
                    <td height="25" align="left" valign="middle" bgcolor="#D3DBE2" class="etiquetas">Anios:</td>
                    <td height="10" align="left" valign="middle" bgcolor="#D3DBE2"><span class="style17">
			    ...
			    <table width="383" height="279" border="0" align="left" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF">
                  ...
                  <tr>
                    <td height="10" align="left" valign="middle" bgcolor="#D3DBE2" class="etiquetas">Castrado:</td>
                    <td height="25" colspan="3" align="left" valign="middle" bgcolor="#D3DBE2"><span class="style17"><span class="Estilo1">
                      <label></label>
                      <label>
                      <input name="checkboxCastrado" type="checkbox" <?php if ($castrado == 1) { ?> checked="checked"  <?php } ?> />
                      </label>
                    </span></span></td>
                  </tr>
                  <tr>
